    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Gerencie suas atividades com eficiência</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition duration-200 disabled:opacity-50"
          >
...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const response = await axios.get(`${API}/activities/stats/dashboard`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ title: '', description: '', category: 'Geral', priority: 'medium', status: 'pending', due_date: '' });
      setShowForm(false);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-semibold text-gray-900">Minhas Atividades</h2>
          <button
            onClick={() => {
              setShowForm(true);
              setEditingActivity(null);
        ...
        <div className="bg-white rounded-xl shadow-sm">
          {activities.length === 0 ? (
            <div className="p-8 text-center">
              ...
              <p className="text-gray-500">Nenhuma atividade encontrada. Crie sua primeira atividade!</p>
            </div>
          ) : (
                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-4 text-sm text-gray-500">
                        ...
                        {activity.due_date && (
                          <span>Prazo: {new Date(activity.due_date).toLocaleDateString('pt-BR')}</span>
                        )}
